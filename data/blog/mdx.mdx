...
Then, I iterated over this list to display all articles when viewing `fluttensor.tk/blog`.
...
- Show [view counts](https://github.com/mj23978/nextjsportfolio/blob/91233631f0e1a193295ffc54d2291f3109060007/components/BlogPost.tsx) for all blog posts, dynamically pulled from Firebase
- Faster page load times
- Switched to [Inter](https://fonts.google.com/specimen/Inter) as my main font
- Fewer files, and a _lot_ of deleted code!

The best part? [**It's all open source**](https://github.com/mj23978/nextjs-portfolio) 🚀
